...
<div ng-controller="UserController as ctrl">
    ...
    <span ng-hide="ctlr.userLoggedIn">
        <form name="form1" ng-submit="ctrl.Login()" role="form" method="post">
        ...
        <div class="form-group" 
             ng-class="{ 'has-error': form.username.$dirty && form.username.$error.required}" >
                ...
                ng-show="form1.username.$dirty && form.username.$error.required"
                ...
                ng-show="form1.password.$dirty && form.password.$error.required"
                class="help-block"> password is required </span>
                 </div>
                 <div class="form-actions">
                    <button type="submit" ng-click="ctrl.login()">Login</button>
                   <a href="#/user" class="btn btn-link">Register</a>
                 </div>
                 </form>
    </span>
    </div>
